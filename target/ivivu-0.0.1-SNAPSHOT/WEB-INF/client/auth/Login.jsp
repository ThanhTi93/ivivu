            ...
            <div class="card p-4 shadow" style="width: 400px;">
                ...
                <form action="login" method="post">
                    <div class="mb-3">
                        ...
                        <input type="text" name="emailOrUsername" class="form-control" placeholder="Nhập email hoặc username" required>
                    </div>
                    ...
                    <button type="submit" class="btn btn-warning w-100 mb-2">Đăng nhập</button>

                    <div class="text-center mb-2">
                        <a href="#" class="text-muted" style="font-size: 0.9rem;">Quên mật khẩu?</a>
                    </div>
