            ...
            <div class="right" id="main-content">
                ...
                <div class="container" >
                    <div class="row row-cols-1 row-cols-md-3">
                        <div class="col mt-3">
                            <h3>List Attractions</h3>
                        </div>
                        <div class="col mt-3">
                            <form action="/attraction"  method="get">
                        ...
                        <div class="col mt-3 text-end">
                            <a href="/addattraction" type="button" class="btn btn-success text-white">Add Attraction</a>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-striped mt-5">
                            ...
                            <tbody>
                                <c:forEach items="${attractions}" var="o">
                                    <tr>
                                        <td >${o.id}</td>
                                        <td>
                                            <img src=${o.imgUrl} alt="Location Image" class="animate__animated animate__flip" style="max-width: 50px; max-height: 50px;">
                                        </td>                         
                                        <td >${o.name}</td>  
                                        <td>${o.getShortDescription()}</td>
                                        <td>
                                            <a href="editattraction?id=${o.id}" class="text-white">
                        ...
                        <nav>
                            <ul class="pagination justify-content-center">
                                <c:if test="${currentPage > 1}">
                                    <li class="page-item">
                                        <a class="page-link" href="location?page=${currentPage - 1}">« Trước</a>
                                    </li>
                                </c:if>

                                <c:forEach begin="1" end="${totalPages}" var="i">
                                    <li class="page-item ${i == currentPage ? 'active' : ''}">
                                        <a class="page-link" href="location?page=${i}">${i}</a>
                                    </li>
                                </c:forEach>

                                <c:if test="${currentPage < totalPages}">
                                    <li class="page-item">
                                        <a class="page-link" href="location?page=${currentPage + 1}">Sau »</a>
                                    </li>
                                </c:if>
                            </ul>
                        </nav>
