                ...
                <div class="container" >
                    <div class="row row-cols-1 row-cols-md-3">
                        ...
                        <div class="col mt-3 text-end">
                            <a href="/addlocation" type="button" class="btn btn-success text-white">Add Location</a>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-striped mt-5">
                            ...
                            <tbody>
                                <c:forEach items="${locations}" var="o">
                                    <tr>
                                        <td >${o.id}</td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="editlocation?id=${o.id}" class="text-white">
