        ...
        <div class="container-fluid admin">
            ...
            <div class="right" id="main-content">
                ...
                <div class="container mt-5">
                    <h2 class="text-center">Edit TourSchedule</h2>
                    <form action="edittourschedule" method="post" enctype="multipart/form-data" class="p-4 shadow-lg rounded bg-light mt-3">
