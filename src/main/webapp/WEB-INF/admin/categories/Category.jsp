            ...
            <div class="right" id="main-content">
              ...
              <div class="row row-cols-1 row-cols-md-3">
                  ...
                  <div class="col mt-3 text-end">
                      <a href="/addcategory" type="button" class="btn btn-success text-white">Add Category</a>
                  </div>
              </div>
                      ...
                      <tbody>
                          <c:forEach items="${categories}" var="c">
                              <tr>
                                  ...
                                  <td>${c.description}</td>
                                  <td>
                                      <a href="editcategory?id=${c.id}" class="text-white">
                  ...
                  <nav>
                      <ul class="pagination justify-content-center">
                          <c:if test="${currentPage > 1}">
                              <li class="page-item">
                                  <a class="page-link" href="category?page=${currentPage - 1}">« Previous</a>
                              </li>
                          </c:if>
                          ...
                          <c:if test="${currentPage < totalPages}">
                              <li class="page-item">
                                  <a class="page-link" href="category?page=${currentPage + 1}">Next »</a>
                              </li>
                          </c:if>
                      </ul>
                  </nav>
              ...
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <div class="modal-footer">
                          ...
                          <form id="deleteForm" method="post" action="deletecategory">
